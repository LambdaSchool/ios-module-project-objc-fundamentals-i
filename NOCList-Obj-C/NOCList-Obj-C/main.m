...
int main(int argc, const char * argv[]) {
    @autoreleasepool {
        ...
        LSIAgent *sarah = [[LSIAgent alloc] initWithCoverName:@"Sarah Davies" realName:@"Kristen Scott Thomas" accessLevel:5 compromised:YES];
        ...
        NSArray *agents = [[NSArray alloc] initWithObjects:ethan,
                           jim,
                           claire,
                           eugene,
                           franz,
